...
import time
import json
from MOD.kaiheila_post_card_message import post_kaiheila_message
from MOD.data_process import timestamp
...
def _result_bilibili_video_info(bvid, target_id):
    ...
    if _video_test_info_json["code"] == 0:
        ...
        # test = requests.post(url=_post_message_url,
        #                      headers={"Authorization": "Bot 1/MTAxNTg=/qg5BV/CJXsHevFG4vIIdlA=="},
        #                      data=message_data)
    else:
